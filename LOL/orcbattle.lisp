...
(defun orc-battle ()
  ...
  (when (monsters-dead)
    (princ "Congratulationsh! You have vanquished all of your foes.")))
...
(defun player-attack ()
  (fresh-line)
  (princ "Attack style: [s]stab [d]ouble swing [r]oundhouse:")
  (case (read)
    ...
    (d (let ((x (randval (truncate (/ *player-strength* 6)))))
	 ...
	 (unless (monsters-dead)
	   (monster-hit (pick-monster) x))))
    (t (dotimes (x (1+ (randval (truncate (/ *player-strength* 3 )))))
		 (unless (monsters-dead)
...
(defmethod monster-attack ((m orc))
  (let ((x (randval (orc-club-level m))))
    (princ "An orc swings his club at you and knocs off ")
    (princ x)
